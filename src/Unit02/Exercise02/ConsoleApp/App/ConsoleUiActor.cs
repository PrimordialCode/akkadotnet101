...
namespace ConsoleApp.App
{
	...
	/// </summary>
	internal class ConsoleUiActor : UntypedActorWithLogs
	{
		protected override void OnReceive(object message)
		{
			...
			switch (msg)
			{
				case "start":
					...
					ColoredConsole.WriteLine("Allowed commands: resumeexception | stopexception | restartexception | escalateexception | stop | poisonpill | kill | gracefulstop | any other text message");
